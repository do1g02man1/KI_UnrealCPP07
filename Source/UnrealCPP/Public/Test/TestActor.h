...
protected:
	...
	UFUNCTION(BlueprintCallable, BlueprintImplementableEvent, Category = "내 함수")	// C++에서 선언만 하고 구현은 블루프린트에서 할 경우 
...
protected:
	...
	UPROPERTY(VisibleInstanceOnly, Category = "Test변수")	// 맵에 배치된 상태에서만 보기 가능
	int32 Data4 = 40;

	UPROPERTY(EditAnywhere, Category = "Test변수")	// 클래스 디폴트나 인스턴스에서 쓰기 가능
	int32 Data5 = 50;

	UPROPERTY(EditDefaultsOnly, Category = "Test변수")	// 클래스 디폴트 창에서만 쓰기 가능
	int32 Data6 = 60;

	UPROPERTY(EditInstanceOnly, Category = "Test변수")	// 맵에 배치된 상태에서만 쓰기 가능
	int32 Data7 = 70;
